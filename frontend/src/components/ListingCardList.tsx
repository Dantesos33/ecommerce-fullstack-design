    ...
    <div className="flex bg-white border border-slate-200 rounded-xl overflow-hidden hover:shadow-md hover:border-blue-200 transition-all duration-300">
      ...
      <div className="flex flex-1 flex-col justify-center gap-1.5 px-4 py-3 border-l border-slate-100">
        <Link
          ...
          className="text-sm font-semibold text-slate-800 line-clamp-1 hover:text-blue-600 transition-colors"
        >
          {product.title}
        </Link>
        ...
        <div className="flex items-center gap-3 mt-1">
          ...
          <button
            ...
            className={`cursor-pointer inline-flex items-center gap-1 text-xs font-semibold transition-colors duration-200 ${
              inCart
